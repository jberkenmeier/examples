...
public class Song
{
	...
	/**
	 * Constructor: Builds an empty song 
	 * 
	 */
	public Song()
	{
	 ...
	 * @param newTitle String name of title
	 */
	 ...
	 * @param newArtist String name of artist
	 */
	 ...
	 * @param newplayTime integer representing seconds of playtime
	 */
	...
	/**
	 * Sets the file path of the song
	 * @param newfilePath String file path of song
	 */
